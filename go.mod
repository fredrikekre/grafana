...
require (
	...
	google.golang.org/api v0.170.0 // @grafana/backend-platform
...
require (
	...
	github.com/googleapis/gax-go/v2 v2.12.2 // @grafana/backend-platform
	...
	google.golang.org/genproto v0.0.0-20240205150955-31a09d347014 // indirect; @grafana/backend-platform
)

require (
	cloud.google.com/go/kms v1.15.6 // @grafana/backend-platform
